...
if __name__ == '__main__':
    ...
    feat_path = 'inter_data/imagenet_' + model_type + '/'
    ...
    data_types = ['brightness', 'contrast', 'defocus_blur', 'elastic_transform', 'fog', 'frost',
                  'gaussian_noise', 'jpeg_compression', 'motion_blur', 'pixelate', 'shot_noise',
                  'snow', 'zoom_blur']
    ...
    for i in trange(len(data_types)):
        path = '/home/qhu/qhu-data/Quan_study/datasets/tiny-imagenet/Tiny-ImageNet-C/' + data_types[i] + '/1/'
        # test dataset (overlap=True--> sample set)
    ...
    np.save('inter_data/dataset_feature/fd_imagenet_densenet_4test.npy', fd_bg)
