...
# data preparation
acc = np.load('inter_data/imagenet_acc_resnet_3.npy')
data = np.load('inter_data/fd_imagenet_resnet_3.npy').reshape(-1, 1)
...
test_data = np.load('inter_data/4test/fd_imagenet_resnet101_4test.npy').reshape(-1, 1)
